    ...
    <div className="content-container" style={{ padding: '40px 24px' }}>
      ...
      <div className="glass-panel animate-slide-up" style={{ padding: '60px 48px' }}>
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          ...
          <h1 className="gradient-text" style={{ fontSize: '48px', marginBottom: '16px', letterSpacing: '-0.02em' }}>Mortgage Calculator</h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '40px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div className="glass-panel animate-fade-in" style={{ padding: '32px', textAlign: 'center', background: 'rgba(50, 215, 75, 0.05)', border: '1px solid rgba(50, 215, 75, 0.2)' }}>
              ...
              <h2 style={{ fontSize: '48px', color: '#32d74b' }}>${monthlyPayment.toLocaleString(undefined, { maximumFractionDigits: 2 })}</h2>
            </div>
