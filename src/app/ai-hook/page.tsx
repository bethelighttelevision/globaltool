        ...
        <div style={{ maxWidth: '900px', margin: '80px auto 0' }}>
          <article className="prose prose-invert lg:prose-xl">
            ...
            <p style={{ color: 'var(--muted)', lineHeight: '1.8', marginBottom: '20px' }}>
              In the age of short-form content where attention spans are shrinking and competition for views is fiercer than ever, you have exactly 1.7 seconds to stop someone from scrolling past your video. Our <strong>AI Hook Generator</strong> is built on psychological principles that help creators craft engaging openings for TikTok, Instagram Reels, and YouTube Shorts. By mastering the critical first few seconds of your video content, you can improve audience retention rates and signal to the algorithm that your content is worth showing to a wider audience. A compelling hook is one of the most important elements of any video strategy.
            </p>
